...
public class New_Employee extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String e = t6.getText();
        String p = t7.getText();
        String qry = "insert into employee values(sequence_1.nextval,'"+n+"','"+g+"','"+a+"','"+s+"','"+c+"','"+e+"','"+p+"')";
       System.out.println("insert into employee values(sequence_1.nextval,'"+n+"','"+g+"','"+a+"','"+s+"','"+c+"','"+e+"','"+p+"')");
        try{
            conn c1 = new conn();
